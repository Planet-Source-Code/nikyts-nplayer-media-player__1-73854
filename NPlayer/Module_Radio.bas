Attribute VB_Name = "Module_Radio"
...
Select Case MMKeyCode 'Monitor which key was pressed
    Case MMkey_Play
        ...
        If Form_Radio.MPlayer.playState = wmppsPlaying Then
            Form_Radio.MPlayer.Controls.pause
            Debug.Print "Pausa"
            Exit Function
        Else
            Form_Radio.MPlayer.Controls.play
    ...
    Case MMkey_Stop
        AppKeyName$ = "Stop"
        Form_Radio.MPlayer.Controls.stop
    ...
    Case MMkey_Prev_Track
        ...
        Form_Radio.MPlayer.Controls.previous
    Case MMkey_Next_Track
        AppKeyName$ = "Next_Track"
        Form_Radio.MPlayer.Controls.Next
    Case Else
        'OnMMKeypress = False
